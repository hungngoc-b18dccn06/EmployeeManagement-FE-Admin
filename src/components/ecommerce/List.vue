...
const productService = {
  async getProductsSmall() {
    try {
      ...
      const data = [
      {"id": "1007","code": "mbvjkgip5","name": "Galaxy Earrings","description": "Product Description","image": "","price": 34,"category": "Accessories","quantity": 23,"inventoryStatus": "INSTOCK","rating": 5},
        {"id": "1008","code": "vbb124btr","name": "Game Controller","description": "Product Description","image": "","price": 99,"category": "Electronics","quantity": 2,"inventoryStatus": "LOWSTOCK","rating": 4},
        {"id": "1009","code": "cm230f032","name": "Gaming Set","description": "Product Description","image": "","price": 299,"category": "Electronics","quantity": 63,"inventoryStatus": "INSTOCK","rating": 3}
      ]
            ...
            <div class="card">
                ...
                <Toolbar class="mb-4">
                    ...
                    <template v-slot:end>
                        ...
                        <Button label="Export" icon="pi pi-upload mr-2" class="p-button-help" @click="exportCSV($event)" />
                    </template>
                </Toolbar>
                ...
                >
                    ...
                    <Column field="inventoryStatus" header="Status" :sortable="true" headerStyle="width:14%; min-width:10rem;">
                        <template #body="slotProps">
                            ...
                            <Tag :value="slotProps.data.inventoryStatus ? slotProps.data.inventoryStatus.toLowerCase() : ''" :severity="getSeverity(slotProps.data)" />
                        </template>
                    </Column>
